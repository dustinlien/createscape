...
export const metadata: Metadata = {
  title: "Streaming Capture Cards 2026 | Console Gaming Setup Guide | Createscape",
  description: "Capture card buying guide for streaming. Elgato, AVerMedia. Complete console gaming streaming setup.",
  keywords: "capture card, streaming setup, Elgato, console streaming"
}
    ...
    <main style={{ background: 'var(--canvas)', color: 'var(--void)', minHeight: '100vh', paddingTop: '64px' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 40px' }}>
        <script type="application/ld+json">
          {`{"@context": "schema.org", "@type": "BlogPosting", "headline": "Streaming Capture Cards 2026 | Console Gaming Setup Guide", "description": "Capture card buying guide for streaming. Elgato, AVerMedia. Complete console gaming streaming setup.", "datePublished": "2026-03-18", "dateModified": "2026-03-18", "author": {"@type": "Organization", "name": "Createscape"}, "keywords": "capture card, streaming setup, Elgato, console streaming"}`}
        </script>
        ...
        <header style={{ marginBottom: '40px', paddingBottom: '24px', borderBottom: '1px solid var(--n-100)' }}>
          <h1 style={{ fontFamily: "'Syne', sans-serif", fontSize: '42px', fontWeight: '700', marginBottom: '16px' }}>
            Streaming Capture Cards 2026 | Console Gaming Setup Guide
          </h1>
